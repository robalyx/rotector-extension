  ...
  <div>
    ...
    <div class="queue-selection-section">
      {#if !optionsLocked}
        ...
        <div class="space-y-4 mb-6">
          ...
          <div
              class="queue-option-card-outfit" class:locked={optionsLocked}
          ...
          <div
              class="queue-option-card-profile" class:locked={optionsLocked}
          ...
          <div
              class="queue-option-card-friends" class:locked={optionsLocked}
          ...
          <div
              class="queue-option-card-groups" class:locked={optionsLocked}
    ...
    <div class="modal-content-section-info">
      ...
      <ul class="modal-content-list">
        <li class="modal-content-list-item-info">Processed by our AI algorithms to detect patterns of
          inappropriate behavior
        </li>
        <li class="modal-content-list-item-info">If flagged by AI, reviewed by human moderators for final
          confirmation
        </li>
    ...
    <div class="modal-content-section-recommendation">
      ...
      <ul class="modal-content-list">
        <li class="modal-content-list-item-recommendation">Have inappropriate content in their profile, avatar,
          etc.
        </li>
    ...
    <div class="modal-content-section-warning">
      ...
      <p style:color="var(--color-text)"><strong>Abuse of this feature</strong> (submitting users without valid
        reason) may result in your IP being banned from using Rotector. We have automatic abuse detection
        measures in place.</p>
    </div>
  </div>
</Modal> 