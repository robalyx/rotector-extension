        ...
        <div class="changelog-version-info">
            ...
            <div class="changelog-meta">
                ...
                <span class="changelog-date"
                    >{new Date(changelog.date).toLocaleDateString()}</span
                >
            </div>
        </div>
    </div>
            ...
            {#each orderedTypes as type (type)}
                <div class="changelog-type-group">
                    <div class="changelog-type-header">
                        {#if type === "added"}
                            <Plus
                                class="changelog-type-icon {getChangeTypeColor(
                                    type,
                                )}"
                                size={16}
                            />
                        ...
                        {/if}
                        <span
                            class="changelog-type-label {getChangeTypeColor(
                                type,
                            )}">{getChangeTypeLabel(type)}</span
                        >
                        <span class="changelog-type-count"
                            >({groupedChanges[type].length})</span
                        >
                    </div>
