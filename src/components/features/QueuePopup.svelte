<script lang="ts">
    ...
    const isReanalysis = $derived(
        isReprocess ||
            (userStatus &&
                userStatus.flagType > 0 &&
                userStatus.flagType !== STATUS.FLAGS.PAST_OFFENDER),
    );
...
>
    <div>
        <p style:color="var(--color-text)" class="mb-6!">
            {#if isReanalysis}
                You are about to submit user (ID: {sanitizedUserId()}) for
                reanalysis by our system.
            {:else}
                You are about to submit user (ID: {sanitizedUserId()}) for
                analysis by our system.
            {/if}
        </p>
        ...
        {#if !isReanalysis}
            <div class="queue-selection-section">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            >
                                ...
                                <div class="queue-option-description">
                                    This user has clear inappropriate content in
                                    their profile, avatar, friends, or groups.
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div class="queue-option-description">
                                    I'm unsure but want this user analyzed for
                ...
                {:else if submissionType === "general-check"}
                    ...
                    <div>
                        ...
                        >
                            This user will be analyzed for general safety
                            concerns. No specific flagging reasons required.
                        </p>
                    </div>
          ...
          "
                        ...
                        >
                            ...
                            <div class="queue-option-description">
                                This user has inappropriate content in their
                                username, display name, or description.
                            </div>
                        </div>
                    ...
                    {#if showValidationError}
                        <div class="mb-4 queue-validation-error">
                            <div class="flex items-center gap-2">
                                <AlertCircle
                                    class="mature-content-warning-icon"
                                    color="#ff9800"
                                    size={32}
                                />
                                <strong>Selection Required:</strong> Please select
                                at least one flagging reason before proceeding.
                            </div>
                        </div>
                    {/if}
        ...
        <div class="modal-content-section-info">
            ...
            <ul class="modal-content-list">
                <li class="modal-content-list-item-info">
                    Analyzed by AI algorithms to detect potential safety
                    concerns
                </li>
                <li class="modal-content-list-item-info">
                    If flagged by AI, reviewed by human moderators for final
                    confirmation
                </li>
                <li class="modal-content-list-item-info">
        ...
        <div class="modal-content-section-warning">
            <h3 class="modal-content-heading flex items-center">
                <AlertTriangle
                    class="mr-2 warning-triangle-icon"
                    color="#ff9800"
                    size={24}
                />
                Important Warning
            ...
            <p style:color="var(--color-text)" class="text-sm">
                <strong>Misuse of this feature</strong> (like spamming submissions)
                may result in restrictions on your account. Automated abuse detection
                is active.
            </p>
        </div>
    </div>
