                ...
                <div class="hexagon-row">
                    {#each row as zone (zone.id)}
                        <div
                            ...
                            onkeydown={(e) =>
                                e.key === "Enter" && handleClick(zone.id)}
                            role="button"
                            tabindex="0"
                        >
                            <div class="hexagon">
                                ...
                                >
                                    <defs>
                                        ...
                                        >
                                            <stop
                                                style:stop-color={getBorderColor(
                                                    zone.liberation,
                                                )}
                                ...
                                <div class="hexagon-content">
                                    <span class="hexagon-zone-id"
                                        >{zone.name}</span
                                    >
                                    <span class="hexagon-liberation"
                                        >{zone.userPercentage.toFixed(1)}%</span
                                    >
                                </div>
                            </div>
                        </div>
