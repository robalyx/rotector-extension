    ...
    changes: [
      {
        type: "added",
        description:
          "Reprocess users - Submit already-checked users for another review if outdated",
      },
      {
        type: "added",
        description:
      ...
      },
      {
        type: "changed",
        description:
          "Improved icon quality with cleaner designs throughout the extension",
      },
      {
        type: "changed",
        description:
          "Improved queue modal design with clearer success and error messages",
      },
      {
        type: "fixed",
        description:
  ...
  },
  {
    ...
    changes: [
      ...
      },
      {
        type: "added",
        description:
          "Friends navigation support - Full support for /users/friends navigation pages",
      },
      {
        type: "changed",
  ...
  },
  {
    ...
    changes: [
      ...
      },
      {
        type: "changed",
        description:
          "Redesigned popup footer - Improved layout and styling of footer section",
      },
      {
        type: "changed",
        description:
