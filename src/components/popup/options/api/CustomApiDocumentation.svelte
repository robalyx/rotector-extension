<script lang="ts">
	...
	const FLAG_ROWS = [
		{
			value: 0,
			nameKey: 'custom_api_docs_flag_row_name_0',
			labelKey: 'custom_api_docs_flag_row_actionable_0',
			descKey: 'custom_api_docs_flag_row_description_0'
		},
		{
			value: 1,
			nameKey: 'custom_api_docs_flag_row_name_1',
			labelKey: 'custom_api_docs_flag_row_actionable_1',
			descKey: 'custom_api_docs_flag_row_description_1'
		},
		{
			value: 2,
			nameKey: 'custom_api_docs_flag_row_name_2',
			labelKey: 'custom_api_docs_flag_row_actionable_2',
			descKey: 'custom_api_docs_flag_row_description_2'
		},
		{
			value: 3,
			nameKey: 'custom_api_docs_flag_row_name_3',
			labelKey: 'custom_api_docs_flag_row_actionable_3',
			descKey: 'custom_api_docs_flag_row_description_3'
		},
		{
			value: 4,
			nameKey: 'custom_api_docs_flag_row_name_4',
			labelKey: 'custom_api_docs_flag_row_actionable_4',
			descKey: 'custom_api_docs_flag_row_description_4'
		},
		{
			value: 5,
			nameKey: 'custom_api_docs_flag_row_name_5',
			labelKey: 'custom_api_docs_flag_row_actionable_5',
			descKey: 'custom_api_docs_flag_row_description_5'
		},
		{
			value: 6,
			nameKey: 'custom_api_docs_flag_row_name_6',
			labelKey: 'custom_api_docs_flag_row_actionable_6',
			descKey: 'custom_api_docs_flag_row_description_6'
		},
		{
			value: 8,
			nameKey: 'custom_api_docs_flag_row_name_8',
			labelKey: 'custom_api_docs_flag_row_actionable_8',
			descKey: 'custom_api_docs_flag_row_description_8'
		}
	] as const;

	const REASONS = [
		{ code: 'User Profile', labelKey: 'custom_api_docs_reason_user_profile' },
		{ code: 'Friend Network', labelKey: 'custom_api_docs_reason_friend_network' },
		{ code: 'Avatar Outfit', labelKey: 'custom_api_docs_reason_avatar_outfit' },
		{ code: 'Group Membership', labelKey: 'custom_api_docs_reason_group_membership' },
		{ code: 'Condo Activity', labelKey: 'custom_api_docs_reason_condo_activity' },
		{ code: 'Chat Messages', labelKey: 'custom_api_docs_reason_chat_messages' },
		{ code: 'Game Favorites', labelKey: 'custom_api_docs_reason_game_favorites' },
		{ code: 'Earned Badges', labelKey: 'custom_api_docs_reason_earned_badges' },
		{ code: 'User Creations', labelKey: 'custom_api_docs_reason_user_creations' },
		{ code: 'Other Reasons', labelKey: 'custom_api_docs_reason_other' }
	] as const;
			...
			<section id="section-flag-types" class="docs-section">
				...
				<div class="docs-table-wrapper">
					<table class="docs-table">
						...
						<tbody>
							{#each FLAG_ROWS as row (row.value)}
								<tr>
									<td><code>{row.value}</code></td>
									<td>{$_(row.nameKey)}</td>
									<td>{$_(row.labelKey)}</td>
									<td>{$_(row.descKey)}</td>
								</tr>
							{/each}
						</tbody>
			...
			<section id="section-reason-types" class="docs-section">
				...
				<ul class="docs-list">
					{#each REASONS as reason (reason.code)}
						<li><code>{reason.code}</code> &mdash; {$_(reason.labelKey)}</li>
					{/each}
				</ul>
