<script lang="ts">
    ...
    const usagePercentage = $derived(() => {
        ...
        return Math.round(
            (queueLimits.current_usage / queueLimits.limit) * 100,
        );
    });
            ...
            <div class="queue-usage-display">
                <div class="queue-usage-labels">
                    ...
                    <div class="queue-usage-label-right">
                        ...
                        <span class="queue-remaining-amount"
                            >{queueLimits.remaining}</span
                        >
                    </div>
                </div>
                ...
                >
                    <div
                        ...
                        class:queue-medium-usage={usagePercentage() >= 50 &&
                            usagePercentage() < 80}
                    ></div>
                </div>
            </div>
