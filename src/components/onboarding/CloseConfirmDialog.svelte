<script lang="ts">
	...
	let { onCancel, onConfirm }: CloseConfirmDialogProps = $props();
</script>

<div class="onboarding-confirm-overlay visible">
	<div class="onboarding-confirm-popup" aria-modal="true" role="alertdialog">
