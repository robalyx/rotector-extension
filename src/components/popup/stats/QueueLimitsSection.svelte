...
<div class="queue-limits-section">
	<h3 class="queue-limits-section-title">{$_('stats_queue_title')}</h3>
	...
	{:else if error}
		<div class="py-4 text-center">
			<div class="text-error mb-3 text-sm font-medium">{$_('stats_queue_error')}</div>
			<button
		...
		<div class="queue-limits-compact">
			...
			<div class="queue-usage-display">
				<div class="queue-usage-labels">
					<div class="queue-usage-label-left">
						<span class="queue-usage-label">{$_('stats_queue_usage')}</span>
						<span class="queue-usage-amount">
							{queueLimits.current_usage} / {queueLimits.limit}
						</span>
					</div>
					<div class="queue-usage-label-right">
						<span class="queue-usage-label">{$_('stats_queue_remaining')}</span>
			...
			<div class="queue-status-info">
				...
				<div class="queue-reset-timer">
					<span class="queue-reset-label">{$_('stats_queue_resets_in')}</span>
