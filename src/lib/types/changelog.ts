	...
	},
	{
		...
		changes: [
			...
			},
			{
				type: 'changed',
				description:
					'Extension popup design - Streamlined banner layouts and moved integration stats to tooltips for cleaner interface'
			},
			{
				type: 'changed',
				description:
					'Settings organization - Simplified page settings into single category and removed unnecessary tooltip toggles'
			},
			{
				type: 'changed',
				description:
					'Page loading performance - Improved responsiveness when navigating between pages for better support for slow-loading pages'
			},
			{
				type: 'changed',
				description:
					'Navigation detection - Faster page change detection using browser events instead of periodic checking'
			},
			{
				type: 'changed',
				description:
					'Extension popup changelog - Simplified changelog display by removing technical descriptions for better readability'
			},
			{
				type: 'changed',
				description:
					'Memory management - Improved extension stability during long browsing sessions'
			},
			{
				type: 'changed',
				description:
					'Status indicator positioning - Repositioned indicators on user and group lists to be less visually distracting'
			},
			{
				type: 'fixed',
				description:
	...
	},
	{
		...
		changes: [
			...
			},
			{
				type: 'changed',
				description:
					'Popup styling architecture - Resolve potential conflicts with Roblox page styles'
			},
			{
				type: 'changed',
				description:
					'Improved page loading responsiveness - Faster element detection with optimized retry timing'
			},
			{
				type: 'changed',
				description:
					'UI border consistency - Replaced asymmetric borders with uniform design across components'
			},
			{
				type: 'changed',
		...
		changes: [
			{
				type: 'added',
				description:
					'Improved queue selection system - Choose specific data types to queue (outfits, profile, friends, groups) with lock-in confirmation'
			},
			{
				type: 'added',
				description:
					'Banned users statistics - View count of users banned by Roblox in the statistics panel'
			},
			{
				type: 'changed',
				description:
					'Improved modal animations - Reduced transition durations for snappier interface interactions'
			},
			{
				type: 'changed',
		...
		changes: [
			{
				type: 'added',
				description:
					'Engine version indicators - See which AI detection engine version analyzed each user for transparency'
			},
			{
				type: 'added',
				description:
					'Theme system - Choose between auto, light, and dark themes to match your preference'
			},
			{
				type: 'added',
				description:
					'Secret developer panel - Advanced users can access additional settings like custom API endpoints and debug logging'
			},
			{
				type: 'added',
				description:
					'Changelog notifications - Stay informed about new features and improvements with in-extension notifications'
			},
			{
				type: 'added',
				description:
					'Cache duration control - Customize how long user status data is cached to balance performance and freshness'
			},
			{
				type: 'added',
				description:
					'Improved queue feedback - Clearer success and error messages when adding users to the review queue'
			},
			{
				type: 'changed',
				description:
					'Completely rebuilt using modern web technology - The entire extension has been rewritten for better speed, stability, and future updates'
			},
			{
				type: 'changed',
				description:
					'Smoother user interface - All buttons, menus, and interactions now feel more responsive and polished'
			},
			{
				type: 'changed',
				description:
					"Better memory management - The extension uses less computer memory and won't slow down your browser during long browsing sessions"
			},
			{
				type: 'changed',
			...
			},
			{
				type: 'fixed',
				description:
					'Memory leak issues - Fixed problems where the extension would gradually use more memory over time'
			},
			{
				type: 'fixed',
				description:
					'Page navigation detection - The extension now more reliably detects when you navigate between different Roblox pages'
			},
			{
				type: 'fixed',
				description:
					'Status indicator positioning - Fixed issues where status indicators could overlap or appear in wrong locations'
			},
			{
				type: 'fixed',
				description:
					'Tooltip display issues - Resolved problems where tooltips might not show or disappear too quickly'
			},
			{
				type: 'fixed',
				description:
					'Batch processing failures - Fixed edge cases where some users in large lists might not get checked'
			},
			{
				type: 'security',
				description:
					'Improved security protections - Strengthened defenses against potential security vulnerabilities and malicious content'
			},
			{
				type: 'security',
				description:
					'Secure external link handling - All external links now properly prevent window.opener access for security'
			},
			{
				type: 'security',
				description:
					'Input sanitization - All user data and API responses are properly sanitized before display'
			}
		]
	}
];
