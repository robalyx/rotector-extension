<script lang="ts">
    ...
    onMount(() => {
        ...
        const handleMessage = (message: {
            ...
            if (
                message.type === "DISCORD_AUTH_COMPLETE" &&
                message.uuid &&
                message.user
            ) {
                handleDiscordAuthComplete(message.uuid, message.user).catch(
                    (error) => {
                        logger.error(
                            "Failed to handle Discord auth completion:",
                            error,
                        );
                    },
                );
    ...
    {:else if !$authStore.isAuthenticated}
        <div class="hunter-signup">
            <p class="hunter-description">
                Join the community to report high-risk confirmed users. Work
                together with hunters worldwide to increase takedown success and
                make Roblox safer for everyone.
            </p>
            ...
            <div class="beta-notice">
                <strong>Closed Beta:</strong> Only available to selected users.
                Join our
                <a
    ...
    {:else if $authStore.profile}
        <div class="hunter-profile">
            ...
            <p class="hunter-welcome">
                Welcome, Hunter! You can now participate in War Zone activities
                and help protect the Roblox community. Visit the Roblox homepage
                to start your hunting missions.
            </p>

            <button
                class="hunter-logout-button"
