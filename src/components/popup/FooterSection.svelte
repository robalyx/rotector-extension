...
<div class="footer-container">
  ...
  <div class="footer-social-section">
    <a class="footer-social-link" href="https://discord.gg/2Cn7kXqqhY" target="_blank">
    ...
    <a class="footer-social-link" href="https://github.com/robalyx" target="_blank">
      <svg class="footer-social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Source Code Link -->
  <div class="footer-social-section">
    <a class="footer-social-link" href="https://github.com/robalyx/rotector-extension" target="_blank">
      <svg class="footer-social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Creator Credit -->
  <p class="footer-credit">Made by jaxron</p>
</div>