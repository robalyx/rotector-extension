...
<div class="major-order-card" class:expiring={isExpiringSoon()}>
    ...
    <div class="order-progress-section">
        <div class="progress-header">
            ...
            <span class="progress-value">{order.currentValue.toLocaleString()} / {order.targetValue.toLocaleString()}</span>
        </div>
        <div class="progress-bar-container">
            <div
                style:width="{order.progress}%" style:background-color="{getProgressColor(order.progress)}"
