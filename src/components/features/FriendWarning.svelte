<script lang="ts">
  import { STATUS, PROFILE_SELECTORS } from '../../lib/types/constants';
  ...
  <div>
    ...
    <div class="friend-warning-why-matters">
      ...
      <ul class="friend-warning-why-matters-list">
        <li class="friend-warning-why-matters-item">This user may engage in inappropriate conversations or behaviors</li>
        <li class="friend-warning-why-matters-item">Your account may be associated with inappropriate users in our system</li>
        <li class="friend-warning-why-matters-item">You could be exposing yourself to unwanted or harmful content</li>
        <li class="friend-warning-why-matters-item">This user has clear evidence of violating Roblox's Terms of Service</li>
      </ul>
    </div>
    ...
    <div class="friend-warning-recommendations">
      ...
      <ul class="friend-warning-recommendations-list">
        ...
        <li class="friend-warning-recommendations-item">Report them to Roblox if you see inappropriate content</li>
