...
{#if isCard}
    <div
        class="report-helper-card {isReportable()
            ? 'reportable'
            : 'not-reportable'}"
    >
        <div class="report-helper-header">
            {#if isReportable()}
                <AlertTriangle
                    class="report-helper-icon reportable"
                    size={24}
                />
            {:else}
            ...
            {#if isReportable()}
                {#if canAutoFill()}
                    ...
                    <p class="report-helper-subtitle">
                        Rotector identified profile content violating Roblox's
                        Terms of Service.
                    </p>

                    {#if reportableContent()}
                        <div class="report-helper-evidence-section">
                            <h4 class="report-helper-evidence-header">
                                Detected Issue
                            </h4>
                                ...
                                {#if (reportableContent()?.evidence?.length ?? 0) > 0}
                                    ...
                                    <ul class="report-helper-evidence-list">
                                        {#each reportableContent()?.evidence || [] as item (item)}
                                            <li
                                                class="report-helper-evidence-item"
                                            >
                                                {item}
                                            </li>
                                        {/each}
                    ...
                    <div class="report-helper-action-section">
                        <p>
                            Click below and Rotector will automatically fill the
                            report form with the appropriate category and
                            details.
                        </p>
                    ...
                    <div class="report-helper-warning-section">
                        ...
                        <div class="report-helper-warning-text">
                            ...
                            <strong>your</strong> Roblox account. Review all information
                            before submitting and only report genuine violations.
                        </div>
                    </div>
                {/if}
            {:else}
                <!-- Not reportable -->
                <p class="report-helper-subtitle">
                    Rotector hasn't detected any clearly reportable content in
                    this user's profile description yet.
                </p>

                <div class="report-helper-info-section">
                    <Info
                        class="report-helper-info-icon"
                        color="var(--color-primary)"
                        size={24}
                    />
                    <div class="report-helper-info-text">
                        <p>
                            <strong>You can still submit a report</strong> if you
                            believe this user is violating Roblox's Terms of Service.
                        </p>
                        <p>
                            Rotector allows reporting of inappropriate content
                            in profile descriptions. We don't detect most report
                            categories, including:
                        </p>

                        <div class="report-helper-list">
                            <div class="report-helper-list-item">
                        ...
                        <p>
                            If you're reporting any of these violations, please
                            continue with your report and provide specific
                            details to help Roblox moderators.
                        </p>
                    </div>
                </div>
            {/if}
          ...
          "
                    >
                        ...
                        <ul class="mt-1 list-inside list-disc space-y-1">
                            ...
                            <li>
                                Use Rotector's auto-fill feature if available
                            </li>
                            <li>
                                Submit the report through Roblox's official
                                system
                            </li>
                        </ul>
                    </div>
